...
public class TK4_Team4 {
    ...
    public static void bubbleSort(int[] data, boolean ascending) {
        ...
        do {
            ...
            System.out.println(Arrays.toString(data));
            pass++;
            n--; // reduce the number of iterations
        } while (swapped && n > 1); // early exit if no swaps are performed or the array is already sorted
        System.out.println();
    ...
    public static void selectionSort(int[] data, boolean ascending) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            pass++;
            n--; // reduce the number of iterations
            if (n == 1) break; // early exit if the array is already sorted
        }
        System.out.println();
        System.out.println("Result of Pass " + (pass - 1));
        System.out.println(Arrays.toString(data));
